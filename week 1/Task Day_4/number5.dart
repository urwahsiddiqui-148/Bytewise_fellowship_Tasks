...
void main() {
  ...
  Job job2 = Job('full stack', 60000.0, 5678);

  // Create Employee objects with Job references
  Employee employee1 = Employee('urwah', 'BRC STAFF COLONY', '03129642836',
      'urwahshafiq23@gmail.com', job1);
  Employee employee2 = Employee('umar sikandar', 'b1 mirpur', '03123456789',
      'umarsiknadar123@gmail.com', job2);
